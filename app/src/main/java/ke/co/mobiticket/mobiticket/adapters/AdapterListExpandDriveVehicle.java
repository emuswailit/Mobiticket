...
public class AdapterListExpandDriveVehicle extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private List<DriveVehicle> items = new ArrayList<>();
    ...
    public interface OnItemClickListener {
        void onItemClick(View view, DriveVehicle obj, int position);
    }
    ...
    public AdapterListExpandDriveVehicle(Context context, List<DriveVehicle> items) {
        this.items = items;
        ctx = context;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof OriginalViewHolder) {
            ...
            final DriveVehicle p = items.get(position);
