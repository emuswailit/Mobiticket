...
public class AdapterListExpandOwnedVehicle extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private List<OwnedVehicle> items = new ArrayList<>();
    ...
    public interface OnItemClickListener {
        void onItemClick(View view, OwnedVehicle obj, int position);
    }
    ...
    public AdapterListExpandOwnedVehicle(Context context, List<OwnedVehicle> items) {
        this.items = items;
        ctx = context;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof OriginalViewHolder) {
            ...
            final OwnedVehicle p = items.get(position);
