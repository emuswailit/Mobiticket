...
public class OwnerActivity extends BaseActivity implements View.OnClickListener {
    ...
    Gson gson=new Gson();
    List<OwnedVehicle> ownedVehicleList = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            ownedVehicleList = serverLoginResponse.getOwned();

            if (ownedVehicleList.size()>0){
                displayVehicles(ownedVehicleList);
                Log.e("conduct veh:", String.valueOf(ownedVehicleList.size()));
                tvVehiclesCount.setText("Vehicles retrieved: "+ ownedVehicleList.size());
            }else {
    ...
    private void displayVehicles(List<OwnedVehicle> conductVehicleList) {
        //set data and list adapter
        AdapterListExpandOwnedVehicle mAdapterDrive = new AdapterListExpandOwnedVehicle(this, ownedVehicleList);
...
//                readOne(obj.getId(), view);
    ...
    public void showCustomYesNoDialog(String title, String message, final OwnedVehicle obj, final View view) {
        try {


            final Dialog dialog = new Dialog(OwnerActivity.this);
            ...
            ((Button) dialog.findViewById(R.id.bt_yes)).setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent =new Intent(OwnerActivity.this, VehicleActivity.class);
...
//                    tvConductorDetails.setText(serverReadOneResponse.getConductor().getFirst_name() +" "+serverReadOneResponse.getConductor().getLast_name()+" "+serverReadOneResponse.getConductor().getPhone_number());
                    ...
                    Toast.makeText(OwnerActivity.this, "Vehicle details not retrieved!", Toast.LENGTH_SHORT).show();
                }
            }
    ...
    private void initLayouts() {
        ...
        tvTitle.setText("Owners");

        recyclerViewOwned=findViewById(R.id.recyclerViewOwned);
        recyclerViewOwned.setLayoutManager(new LinearLayoutManager(this));
        recyclerViewOwned.addItemDecoration(new LineItemDecoration(this, LinearLayout.VERTICAL));
