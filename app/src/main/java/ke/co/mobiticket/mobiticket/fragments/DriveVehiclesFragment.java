...
public class DriveVehiclesFragment extends Fragment {
    ...
    public static DriveVehiclesFragment newInstance(List<DriveVehicle>  driveVehicleList) {
        DriveVehiclesFragment fragment = new DriveVehiclesFragment();
        fragment.driveVehicleList = driveVehicleList;
        return fragment;
    }
    ...
    private void initViews(View view) {
        ...
        recyclerViewDrive=view.findViewById(R.id.recyclerViewDrive);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        try {
            ...
            if (driveVehicleList.size()>0) {
                ...
                int vehicles = 0;
                for (DriveVehicle driveVehicle : driveVehicleList) {
                    if (driveVehicle.getRegistration_number().equals(" ")) {
                ...
                tvHeader.setText("Vehicles you drive:  " + String.valueOf(vehicles));

                recyclerViewDrive.setLayoutManager(new LinearLayoutManager(getActivity()));
                recyclerViewDrive.addItemDecoration(new LineItemDecoration(getActivity(), LinearLayout.VERTICAL));
                recyclerViewDrive.setHasFixedSize(true);
                //set data and list adapter
                AdapterListExpandDriveVehicle mAdapterDrive = new AdapterListExpandDriveVehicle(getActivity(), driveVehicleList);
