...
public class Vehicle {
    ...
    private String operator_trading_name;
    ...
    public String getOperator_trading_name() {
        return operator_trading_name;
    }

    public void setOperator_trading_name(String operator_trading_name) {
        this.operator_trading_name = operator_trading_name;
    }
